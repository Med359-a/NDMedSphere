                ...
                <form onSubmit={onCreate} className="mt-5 grid gap-4">
                  ...
                  <div className="grid gap-1.5">
                    ...
                    <textarea
                      ...
                      className="min-h-28 w-full rounded-xl border border-black/10 bg-white/80 px-3 py-2.5 text-sm shadow-sm outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/15 dark:border-white/15 dark:bg-zinc-950/60"
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    <div className="flex items-start justify-between gap-3">
                      <h3 className="font-semibold text-zinc-900 dark:text-zinc-50 leading-snug group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition-colors">
                        {s.title}
                      </h3>
                      {isAdmin && (
                        <button
                    ...
                    <div className="mt-auto pt-4 flex items-center gap-1.5 text-sm font-semibold text-emerald-600 dark:text-emerald-400">
                      Read note
