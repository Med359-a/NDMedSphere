        ...
        <Container className="py-16 sm:py-20">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative animate-fade-up stagger-2">
              <div className="absolute -inset-6 -z-10 rounded-[2rem] bg-gradient-to-br from-sky-500/12 via-blue-500/8 to-transparent blur-2xl" />
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            ...
            <div className="grid gap-4 lg:col-span-2 md:grid-cols-2">
              {t.about.cards.map((card, i) => (
                ...
                >
                  <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-lg bg-blue-500/10 dark:bg-blue-400/10">
