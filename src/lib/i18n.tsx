...
export const dictionary = {
  en: {
    ...
    doctors: {
      ...
      intro: "Browse doctor profiles with photos and professional biographies.",
      admin_card_title: "Add doctor",
      admin_card_body: "Upload a name, profile photo, and biography. Editing is admin-only.",
      related_title: "Professional profiles",
      related_body: "Each profile can include a portrait and a short professional biography.",
  ...
  ka: {
    ...
    doctors: {
      ...
      intro: "დაათვალიერეთ ექიმების პროფილები ფოტოებითა და პროფესიული ბიოგრაფიებით.",
      admin_card_title: "ექიმის დამატება",
      admin_card_body: "ატვირთეთ სახელი, პროფილის ფოტო და ბიოგრაფია. რედაქტირება მხოლოდ ადმინისთვისაა ხელმისაწვდომი.",
      related_title: "პროფესიული პროფილები",
      related_body: "თითოეული პროფილი შეიძლება მოიცავდეს ფოტოს და მოკლე პროფესიულ ბიოგრაფიას.",
