...
export const dictionary = {
  ...
  ka: {
    ...
    doctors: {
      ...
      intro: "ექიმების პროფილები 40-ზე მეტი სამედიცინო სპეციალობის მიხედვით.",
      ...
      related_title: "სპეციალობის მიხედვით",
      related_body: "",
      related_about: "შესახებ",
